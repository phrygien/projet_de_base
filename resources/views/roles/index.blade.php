                ...
                @endif
                 <div class="card mg-b-20">
                    <div class="card-header">
                       ...
                       @can('role-create')
                       <a href="{{ route('roles.create') }}" class="btn btn-primary btn-sm ml-2">Créer</a>
                       @endcan
                    </div>
                     ...
                     <table class="table table-responsive-sm">
                        ...
                        <tbody>
                           ...
                           <tr>
                               ...
                               <td>{{ $role->name }}</td>
                               <td>
                                   <a class="btn btn-success" href="{{ route('roles.show',$role->id) }}">{{ __('Details') }}</a>
                                   @can('role-edit')
                                       <a class="btn btn-primary" href="{{ route('roles.edit',$role->id) }}">{{ __('Editer') }}</a>
                                   @endcan
                                   @can('role-delete')
                                    ...
                                    <div class="modal-dialog modal-sm" role="document">
                                       <div class="modal-content">
                                          ...
                                          <div class="modal-body">
                                             {{ __('Voulez vous vraiment supprimer le role ?') }}
                                          </div>
